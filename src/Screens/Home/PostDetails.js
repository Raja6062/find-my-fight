                ...
                <div className="rightHead">
                  <div className="homePageRight">
                    <div className="headSlide">
                      <span onClick={() => filterModalshow(true)}><i class="fal fa-sliders-h"></i></span>
                    </div>
          ...
          <div className="row">
            ...
            <div className="col-lg-7">                
              ...
              <div className="postSection">
                <div className="postTop">
                  <div className="postTplft">
                    ...
                    <div>
                      ...
                      <p>
                        2h ago . <i class="fas fa-map-marker-alt"></i> Virginia,
                        US . &nbsp;&nbsp;
                        <a href="">
                ...
                <p>
                It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout Content here, content here', making it look like readable. It is a long established fact that a reader will be distracted by the readable content of a page when
                </p>
                <div className="postBnr">
                  <div className="postSlider">
                  <Carousel>
                    <Carousel.Item>
                        <img className="d-block w-100" src="../images/bnr1.jpg" alt="First slide"/>
                        {/* <Carousel.Caption>
                    ...
                    <Carousel.Item>
                        <img className="d-block w-100" src="../images/bnr1.jpg" alt="Second slide"/>
                    </Carousel.Item>
                    <Carousel.Item>
                        <img className="d-block w-100" src="../images/bnr1.jpg" alt="Third slide"/>                        
                    </Carousel.Item>
                    </Carousel>
                  </div>
                </div>
                ...
                <div className="postComntBase">
                    ...
                    <div className="postComment">
                        ...
                        <div className="postComInn">
                            <h5>John Betania</h5>
                            <p>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout Content here, content here', making it look like readable. </p>
                        </div>
                    </div>
